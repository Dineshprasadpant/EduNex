...
namespace EduNex.Services
{
    ...
    {
        Task<object> CreateNewsAsync(CreateNewsDto news);
    ...
    public class NewsService : INewsService
    {
        ...
        public async Task<object> CreateNewsAsync(CreateNewsDto news)
        {
            News n = new News
            {
                Id = new Guid(),
                ...
                ResourceMaterials=news.ResourceMaterials,
                Content=news.Content
            };
            var id = await _dal.CreateAsync(n);
